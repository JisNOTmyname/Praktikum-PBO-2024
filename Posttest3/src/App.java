...
class NasabahIndividu extends Nasabah {
    private String npwp;

    public NasabahIndividu(String nama, String nomorRekening, String cif, String nomorKTP, String alamat, Date tanggalLahir, String namaIbuKandung, String pekerjaan, String npwp) {
        super(nama, nomorRekening, cif, nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan);
        this.npwp = npwp;
    }
...
class NasabahPerusahaan extends Nasabah {
    private String namaPerusahaan;
    private String npwpPerusahaan;

    public NasabahPerusahaan(String nama, String nomorRekening, String cif, String nomorKTP, String alamat, Date tanggalLahir, String namaIbuKandung, String pekerjaan, String namaPerusahaan, String npwpPerusahaan) {
        super(nama, nomorRekening, cif, nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan);
    ...
    public String toString() {
        return super.toString() +
                ...
                "\nNPWP Perusahaan: " + npwpPerusahaan;
    }
}

class NasabahPremium extends Nasabah {
    private double limitKredit;
    private double saldoInvestasi;

    public NasabahPremium(String nama, String nomorRekening, String cif, String nomorKTP, String alamat, Date tanggalLahir, String namaIbuKandung, String pekerjaan, double limitKredit, double saldoInvestasi) {
        super(nama, nomorRekening, cif, nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan);
        this.limitKredit = limitKredit;
        this.saldoInvestasi = saldoInvestasi;
    }
    ...
    public double getSaldoInvestasi() {
        return saldoInvestasi;
    }

    public void setSaldoInvestasi(double saldoInvestasi) {
        this.saldoInvestasi = saldoInvestasi;
    }
    ...
    public String toString() {
        return super.toString() +
                ...
                "\nSaldo Investasi: " + saldoInvestasi;
    }
}
            ...
            switch (menu) {
                case 1:
                    if (!dataNasabahDitambahkan) {
                        ...
                        System.out.print("Apakah nasabah merupakan individu atau perusahaan? (I/P): ");
                        String jenisNasabah = scanner.nextLine();
                        if (jenisNasabah.equalsIgnoreCase("I")) {
                            System.out.print("Masukkan NPWP: ");
                            String npwp = scanner.nextLine();
                            bankSyariah.tambahNasabah(new NasabahIndividu(nama, "", "", nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan, npwp));
                        } else if (jenisNasabah.equalsIgnoreCase("P")) {
                            System.out.print("Masukkan nama perusahaan: ");
                            String namaPerusahaan = scanner.nextLine();
                            System.out.print("Masukkan NPWP perusahaan: ");
                            String npwpPerusahaan = scanner.nextLine();
                            bankSyariah.tambahNasabah(new NasabahPerusahaan(nama, "", "", nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan, namaPerusahaan, npwpPerusahaan));
                        } else {
